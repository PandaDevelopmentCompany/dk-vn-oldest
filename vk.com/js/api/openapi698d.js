...
if (!VK.Widgets) {
  ...
  VK.Widgets.Comments = function(objId, options, page) {
    ...
    return VK.Widgets._constructor('widget_comments.html', objId, options, params, {
  ...
  VK.Widgets.Recommended = function(objId, options) {
    ...
    return VK.Widgets._constructor('widget_recommended.html', objId, options, params, {}, {
  ...
  VK.Widgets.Post = function(objId, ownerId, postId, hash, options) {
    ...
    return VK.Widgets._constructor('widget_post.html', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box(VK.Util.getAbsUrl(url), [], {
          proxy: rpc
        });
  ...
  VK.Widgets.TextLive = function(widgetRootElementId, textLiveId, textPostId, hash, options) {
    ...
    return VK.Widgets._constructor('widget_textlive.html', widgetRootElementId, options, {
  ...
  VK.Widgets.Like = (function(Like) {
    ...
    Like = function(objId, options, page) {
      ...
      var widgetId = VK.Widgets._constructor('widget_like.html', objId, options, params, {
  ...
  VK.Widgets.Poll = function(objId, options, pollId) {
    ...
    var rpc;
    return VK.Widgets._constructor('al_widget_poll.html', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box(VK.Util.getAbsUrl(url), [], {
          proxy: rpc
        });
  ...
  VK.Widgets.App = function(objId, app_id, options) {
    ...
    return VK.Widgets._constructor('widget_app.html', objId, options, params, {}, {
  ...
  VK.Widgets.Community = VK.Widgets.Group = function(objId, options, gid) {
    ...
    return VK.Widgets._constructor('widget_community.html', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box(VK.Util.getAbsUrl(url), [], {
          proxy: rpc
        });
  ...
  VK.Widgets.Auth = function(objId, options) {
    ...
    return VK.Widgets._constructor('widget_auth.html', objId, options, {}, {makeAuth: function(data) {
      if (data.session) {
        VK.Auth._loadState = 'loaded';
  ...
  VK.Widgets.Subscribe = function(objId, options, oid) {
    ...
    return VK.Widgets._constructor('widget_subscribe.html', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box(VK.Util.getAbsUrl(url), [], {
          proxy: rpc
        });
  ...
  VK.Widgets.ContactUs = function(objId, options, oid) {
    ...
    return VK.Widgets._constructor('widget_contactus.html', objId, options, params, {}, {
  ...
  VK.Widgets.Bookmarks = function(objId, options) {
    ...
    return VK.Widgets._constructor('widget_bookmarks.html', objId, options, params, {}, {
      startHeight: params.height,
      height: params.height
    }, function(o, i, r) {
      rpc = r;
  ...
  VK.Widgets.Playlist = function(objId, ownerId, playlistId, hash, options) {
    ...
    return VK.Widgets._constructor('widget_playlist.html', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box(VK.Util.getAbsUrl(url), [], {
          proxy: rpc
        });
  ...
  VK.Widgets.Ads = function(objId, options, paramsExtra) {
    ...
    return VK.Widgets._constructor('ads_rotate.html', objId, options, params, funcs, defaults, onDone);
    ...
    function adsAttachScript(adsScriptData) {
      if (!('vk__adsLight' in window)) {
        ...
        if (Array.isArray(adsScriptData)) {
          ...
          attachScriptFunc(VK._domain.base + jsc('web/ads_lightd41d.html?') + adsScriptVersion);
        }
  ...
  VK.Widgets.AllowMessagesFromCommunity = function (objId, options, groupId) {
    ...
    return VK.Widgets._constructor('widget_allow_messages_from_community.html', objId, options, params, {}, {
      startHeight: params.height,
      height: params.height
    }, function(o, i, r) {
      rpc = r;
  ...
  VK.Widgets.Article = function(id, url, options) {
    ...
    var rpc;
    return VK.Widgets._constructor('widget_article.html', id, options, params, {
  ...
  VK.Widgets.Podcast = function(id, episode, options) {
    ...
    return VK.Widgets._constructor('widget_podcast.html', id, options, params, {
      showBox: function(url) {
        var box = VK.Util.Box(VK.Util.getAbsUrl(url), [], {
          proxy: rpc
        });
  ...
  VK.Widgets.CommunityMessages = (function(CommunityMessages) {
    ...
    */
    CommunityMessages = function(objId, gid, options) {
      ...
      var chatRpc, chatIfr;
      var inited = 0, timers = {};
      instances[objId] = VK.Widgets._constructor('reforged_widget.html', objId, options, params, {
        ...
        fatalError: function(error_code, public_id) {
          ...
          CommunityMessages.destroy(objId);
          var box = VK.Util.Box(VK.Util.getAbsUrl('blankd41d.html?'+query_str.join('&')));
          box.show();
        },
...
try{stManager.done('api/openapi.html');}catch(e){}
